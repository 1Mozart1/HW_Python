...
n = list(randint(1, 40) for i in range(int(input('Введите кол-во кустов: '))))
print("Кол-во ягод на каждом кусту: ", n)
kyct = int(input('Введите куст с которого нужно собрать урожай: '))
res = 0
if kyct == 1:
    res = n[-1] + n[0] + n[1]
elif kyct == len(n):
    ...
    res = n[kyct] + n[kyct-1] + n[kyct+1]
print("Мак-ое кол-во ягод: ", res)
